            ...
            function makeMarker() {
                ...
                uniqueFeatures.forEach(feature => {
                    ...
                    eventsAtLocation.forEach(event => {
                        ...
                        const imageSrc = event.image?.[0]?.image
                        ...
                        const upcomingTrials = event.tried_upcoming_shows?.map(u => u.common_master?.name).filter(Boolean).join(" | ") || "";

                        const fromDateText = event.product_detail?.fromdate
                        ...
                        <div class="feat_card_bx list-page-card">
                            ...
                            <div class="content">
                                ...
                                <div class="location">
                                <img src="/front/home/assets/images/icons/loction_icn.svg" alt="location-icon" />
                                <span>
