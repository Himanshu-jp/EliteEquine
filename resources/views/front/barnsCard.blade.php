            ...
            <div class="col-lg-4 mb-3">
                <div class="feat_card_bx grid-view">
                    ...
                    <div class="content">
                        ...
                        <h4>Daily Rent Price: ${{ number_format(@$value->productDetail->daily_board_rental_rate) }}
                        </h4>
                        <h4>Weekly Rent Price: ${{ number_format(@$value->productDetail->weekly_board_rental_rate) }}
                        </h4>
                        <h4>Monthly Rent Price: ${{ number_format(@$value->productDetail->monthly_board_rental_rate) }}
                        </h4>
  ...
  var latLng1 = `${event.product_detail.trail_latitude},${event.product_detail.trail_longitude}`;
            ...
            function makeMarker() {
                ...
                uniqueFeatures.forEach(feature => {
                    ...
                    if (isTrail == 1) {
                        var markerIconUrl = "{{ url('/') }}/images/Barn and housing Red.png";
                    } else {
                        var markerIconUrl = "{{ url('/') }}/images/Barn and housing Blue.png";
                    }
                    ...
                    eventsAtLocation.forEach(event => {
                        ...
                        var upcomingTrials = event.tried_upcoming_shows?.map(u => u.common_master?.name).filter(
                            Boolean).join(" | ") || "";

                        var fromDateText = event.product_detail?.fromdate ?
                        ...
                        popupContent += `
                        <div class="feat_card_bx list-page-card">
                            <a href="${baseUrl}/barnsDetails/${event.id}" target="_blank">
                                <div class="imagelist">
                            ...
                            <div class="content">
                                ...
                                <h4>Daily Rent Price: $${event.product_detail?.daily_board_rental_rate?.toLocaleString()}</h4>
                                <h4>Weekly Rent Price: $${event.product_detail?.weekly_board_rental_rate?.toLocaleString()}</h4>
                                <h4>Monthly Rent Price: $${event.product_detail?.monthly_board_rental_rate?.toLocaleString()}</h4>
                                <h4>Sale Price: $${event.product_detail?.sale_cost?.toLocaleString()}</h4>
                                ...
                                <div class="bx2">
                                    <a href="${baseUrl}/barnsDetails/${event.id}" target="_blank">Deatil</a>
                                </div>
                                </div>
                            </div>
                            </div>
