        ...
        <script>
            ...
            function makeMarker() {
                ...
                uniqueFeatures.forEach(feature => {
                    ...
                    if (isTrail == 1) {
                        var markerIconUrl = "{{ env('MAP_PUBLIC') }}/images/Equipment Red.png";
                    } else {
                    ...
                    eventsAtLocation.forEach(event => {
                        ...
                        popupContent += `
                        <div class="feat_card_bx list-page-card">
                            <a href="${baseUrl}/equipmentDetails/${event.id}" target="_blank">
                                <div class="imagelist">
                            ...
                            <div class="content">
                                ...
                                <h4 class="mb-1">Price: $${Number(event.product_detail.price).toLocaleString()}</h4>

                                <div class="location">
                                <img src="${baseUrl}/public/front/home/assets/images/icons/loction_icn.svg" alt="location-icon" />
                                <span>${event.product_detail.city}, ${event.product_detail.state}, ${event.product_detail.country}</span>
                                </div>
                                ...
                                <div class="bx2">
                                   <a href="${baseUrl}/equipmentDetails/${event.id}" target="_blank">Deatil</a>
                                </div>
                                </div>
                            </div>
                            </div>
