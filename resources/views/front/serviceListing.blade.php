                ...
                <div class="col-lg-2">
                    ...
                    <div class="filter-sidebar" id="filterSidebar">
                        ...
                        <div class="filter-section">
                            ...
                            <select id="jobListingType" class="form-select form-control select2" name="jobListingType[]"
                                multiple>
                        ...
                        <div class="filter-section">
                            ...
                            <select id="contractTypes" class="form-select form-control select2" name="contractTypes[]"
                                multiple>
                        ...
                        <div class="filter-section">
                            ...
                            <select id="assistanceUpcomingShows" class="form-select form-control select2"
                                name="assistanceUpcomingShows[]" multiple>
                        ...
                        <div class="filter-section">
                            ...
                            <div class="price-range-min-max">
                                <div>
                                    <label for="trial_from">From</label>
                                    <input type="text" class="form-control datepicker" id="ttrial_from"
                                        name="trial_from" />
                                </div>
                                <span>
                                    <label for="keyword">&nbsp</label>
                        ...
                        <div class="filter-section">
                            ...
                            <select id="haulings_location_from" class="form-select form-control select2"
                                name="haulings_location_from[]" multiple>
                        ...
                        <div class="filter-section">
                            ...
                            <select id="haulings_location_to" class="form-select form-control select2"
                                name="haulings_location_to[]" multiple>
                        ...
                        <div class="filter-section">
                            ...
                            <div class="price-range-min-max">
                                ...
                                <div>
                                    ...
                                    <input type="text" class="input-filter numbervalid" id="maxStall"
                                        name="maxStall" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="filter-section">
                            ...
                            <div class="price-range-min-max">
                                <div>
                                    <label for="keyword">Min</label>
                                    <input type="text" class="input-filter numbervalid" id="minSalary"
                                        name="minSalary" />
                                </div>
                                <span>
                                    <label for="keyword">&nbsp</label>
                                ...
                                <div>
                                    <label for="keyword">Max</label>
                                    <input type="text" class="input-filter numbervalid" id="maxSalary"
                                        name="maxSalary" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="filter-section">
                            ...
                            <div class="price-range-min-max">
                                <div>
                                    <label for="keyword">Min</label>
                                    <input type="text" class="input-filter numbervalid" id="minHourlyPay"
                                        name="minHourlyPay" />
                                </div>
                                <span>
                                    <label for="keyword">&nbsp</label>
                                ...
                                <div>
                                    <label for="keyword">Max</label>
                                    <input type="text" class="input-filter numbervalid" id="maxHourlyPay"
                                        name="maxHourlyPay" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="filter-section">
                            ...
                            <div class="price-range-min-max">
                                <div>
                                    <label for="keyword">Min</label>
                                    <input type="text" class="input-filter numbervalid" id="minFixedPay"
                                        name="minFixedPay" />
                                </div>
                                <span>
                                    <label for="keyword">&nbsp</label>
                                ...
                                <div>
                                    <label for="keyword">Max</label>
                                    <input type="text" class="input-filter numbervalid" id="maxFixedPay"
                                        name="maxFixedPay" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="results-bar">
                            ...
                            <div class="results-right">
                                ...
                                <div class="view-toggle">
                                    <input type="radio" id="view_grid" name="view_mode" value="grid" hidden checked>
                                    <label for="view_grid" class="view-btn active">
                                        <img src="{{ asset('front/home/assets/images/gridicon.svg') }}" alt="Grid View">
                                    </label>

                                    <input type="radio" id="view_map" name="view_mode" value="map" hidden>
                                    <label for="view_map" class="view-btn">
                    ...
                    <div class="map-locations">
                        ...
                        <div class="top-form">
                            <div class="search-box">
                                <input type="text" placeholder="Search for" id="search"
                                    value="{{ @$filter['search'] }}" class="form-control" />
                            ...
                            <div class="search-box">
                                <input type="text" placeholder="Located in" class="form-control"
                                    value="{{ @$filter['location'] }}" id="location" />
                                <img class="icon-input" src="{{ asset('front/home/assets/images/search-icon.svg') }}">
                            </div>

                            <div class="date-box">
                                <input type="text" class="inner-form form-control mb-0 datepicker" autocomplete="off"
                            ...
                            <button class="search-btn btn btn-warning"
                                onclick="window.location.href='{{ route('service-listing') }}'">Reset</button>
                        </div>
                            ...
                            @else
                                <div class="col-md-8 mx-auto noDataFound" style="display:none;">
                                    <div class="notification-box">
                                        ...
                                        <h5 class="my-4">No ads found matched your criteria</h5>
                                        <hr>
                                        <a href="javascript:;" class=" go-to-notify-on text-gold"><u>Select Your
                                                Notifications Settings</u></a>
