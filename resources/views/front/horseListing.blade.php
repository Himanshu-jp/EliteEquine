                    ...
                    <div class="filter-sidebar" id="filterSidebar">
                        ...
                        <div class="filter-section">
                            ...
                            <div class="price-range-min-max">
                                <div>
                                    <label for="keyword">Min</label>
                                    <input type="text" class="input-filter numbervalid" id="minLeasePrice"
                                        name="minLeasePrice" />
                                </div>
                                <span>
                                    <label for="keyword">&nbsp</label>
                                ...
                                <div>
                                    <label for="keyword">Max</label>
                                    <input type="text" class="input-filter numbervalid" id="maxLeasePrice"
                                        name="maxLeasePrice" />
                                </div>
                            </div>
                        ...
                        <div class="filter-section ">
                            ...
                            <div class="filter-ads-checkbx">
                                @foreach (__disciplinesData() as $key => $val)
                                    <input type="checkbox" id="discipline_{{ $key }}" value="{{ $key }}"
                                        name="discipline[]"
                        ...
                        <div class="filter-section">
                            ...
                            <select id="trainingShowExperiences" class="form-select form-control select2"
                                name="trainingShowExperiences[]" multiple>
                        ...
                        <div class="filter-section">
                            ...
                            <select id="greenEligibilities" class="form-select form-control select2"
                                name="greenEligibilities">
                        ...
                        <div class="filter-section">
                            ...
                            <select id="currentFenceHeight" class="form-select form-control select2"
                                name="currentFenceHeight[]" multiple>
                        ...
                        <div class="filter-section">
                            ...
                            <select id="potentialFenceHeight" class="form-select form-control select2"
                                name="potentialFenceHeight[]" multiple>
                        ...
                        <div class="filter-section">
                            ...
                            <select id="triedUpcomingShows" class="form-select form-control select2"
                                name="triedUpcomingShows[]" multiple>
                        ...
                        <div class="filter-section">
                            ...
                            <div class="price-range-min-max">
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control datepicker" id="ftrial_to"
                                        name="ftrial_to" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="filter-section">
                            ...
                            <div class="price-range-min-max">
                                ...
                                <div>
                                    <label for="trial_to">To</label>
                                    <input type="text" class="form-control datepicker" id="ttrial_to"
                                        name="trial_to" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="filter-section">
                            ...
                            <select id="sirebloodline" class="form-select form-control select2" name="sirebloodline[]"
                                multiple>
                        ...
                        <div class="filter-section">
                            ...
                            <select id="dambloodline" class="form-select form-control select2" name="dambloodline[]"
                                multiple>
                        ...
                        <div class="top-form">
                            <div class="search-box">
                                <input type="text" placeholder="Search for" id="search"
                                    value="{{ @$filter['search'] }}" class="form-control" autocomplete="off" />
                            ...
                            <button class="search-btn btn btn-warning"
                                onclick="window.location.href='{{ route('horse-listing') }}'">Reset</button>
                        </div>
