                    ...
                    <div class="info-desc">
                        ...
                        <div class="horse-info-box">
                            ...
                            <div class="horse-info-row"><span class="horse-label">Age:</span> 
                                {{ (@$products->productDetail->age)?\Carbon\Carbon::parse("01-01-".@$products->productDetail->age)->age:0}} Years
                            </div>
                            ...
                            <div class="horse-info-row"><span class="horse-label">Sex:</span> {{@$products->sex->commonMaster->name}}</div>
                            ...
                            <div class="horse-info-row"><span class="horse-label">Green Eligibility:</span> {{@$products->greenEligibilities->commonMaster->name}}</div>
                            ...
                            <div class="horse-info-row"><span class="horse-label">Trial Dates Available:</span>
                                {{ \Carbon\Carbon::parse(@$products->productDetail->fromdate)->format('d M Y') }} - {{ \Carbon\Carbon::parse(@$products->productDetail->todate)->format('d M Y') }}
                            </div>
