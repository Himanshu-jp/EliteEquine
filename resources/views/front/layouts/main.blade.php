...
$(document).ready(function () {
    ...
    $('#submitReview').on('click', function () {
        ...
        if (!selectedRating || selectedRating < 1 || selectedRating > 5) {
            $('<div class="text-danger mt-1" style="font-size:11px;">Please select a rating.</div>').insertAfter('.rate');
            valid = false;
        }

        // Validate message
        if (!message || message.length < 5) {
            $('<div class="text-danger mt-1" style="font-size:11px;">Please enter at least 5 characters in your message.</div>').insertAfter('#contactMessage');
            valid = false;
        }
        ...
        if (image) {
            ...
            if (!validTypes.includes(image.type)) {
                $('<div class="text-danger mt-1" style="font-size:11px;">Only JPG, PNG, WEBP, or SVG images are allowed.</div>').insertAfter('#reviewImage');
                valid = false;
            }
        }
...
<!-- Compare popip -->
<div class="modal fade" id="compareModal" aria-hidden="true" aria-labelledby="Compare" tabindex="-1" style="overflow-x: auto;">
