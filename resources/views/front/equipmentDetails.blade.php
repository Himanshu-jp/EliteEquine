...
@section('content')
                    ...
                    <div class="left-side-deatils">
                        ...
                        <div class="info-desc">
                            ...
                            <div class="horse-info-box">
                                ...
                                <div class="horse-info-row"><span class="horse-label">Hourly Price :</span>
    ...
    <script>
        ...
        function initializeMap(latitude, longitude, trailLat, trailLong) {
            ...
            var markerIconUrl = "{{ env('MAP_PUBLIC') }}/images/Equipment Blue.png";
            ...
            var markerIconUrlTrail = "{{ env('MAP_PUBLIC') }}/images/Equipment Red.png";
