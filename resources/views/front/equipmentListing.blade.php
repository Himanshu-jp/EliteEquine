                  ...
                  <div class="filter-section">
                    ...
                    <div class="filter-section">
                        <label for="horseApparels">Horse Apparel</label>
                         <select id="horseApparels" class="form-select form-control select2" name="horseApparels[]" multiple>
                            @foreach(__getHorseApparealsData() as $key=>$val)
                    ...
                    <div class="filter-section">
                        <label for="riderApparels">Rider Apparel</label>
                         <select id="riderApparels" class="form-select form-control select2" name="riderApparels[]" multiple>
                            @foreach(__getRiderApparealsData() as $key=>$val)
                                <option value="{{$key}}">{{$val}}</option>
                            @endforeach          
                        </select>
                    </div>
                    ...
                    <div class="filter-section">
                        <label for="horseTacks">Horse Track</label>
                         <select id="horseTacks" class="form-select form-control select2" name="horseTacks[]" multiple>
                            @foreach(__getHorseTacksData() as $key=>$val)
                                <option value="{{$key}}">{{$val}}</option>
                            @endforeach          
                        </select>
                    </div>
                    ...
                    <div class="filter-section">
                        <label for="trailerTrucks">Horse Trailers (& Trucks)</label>
                         <select id="trailerTrucks" class="form-select form-control select2" name="trailerTrucks[]" multiple>
                            @foreach(__getTrailerTrucksData() as $key=>$val)
                                <option value="{{$key}}">{{$val}}</option>
                            @endforeach          
                        </select>
                    </div>
                    ...
                    <div class="filter-section">
                        <label for="forBarns">For the Barn</label>
                         <select id="forBarns" class="form-select form-control select2" name="forBarns[]" multiple>
                            @foreach(__getForBarnsData() as $key=>$val)
                                <option value="{{$key}}">{{$val}}</option>
                            @endforeach          
                        </select>
                    </div>
                    ...
                    <div class="filter-section">
                        <label for="equineSupplements">Equine Supplements & Treats</label>
                         <select id="equineSupplements" class="form-select form-control select2" name="equineSupplements[]" multiple>
                            @foreach(__getEquineSupplementsData() as $key=>$val)
                                <option value="{{$key}}">{{$val}}</option>
                            @endforeach          
                        </select>
                    </div>
                    ...
                    <div class="filter-section">
                        <label for="conditions">Condition</label>
                         <select id="conditions" class="form-select form-control select2" name="conditions[]" multiple>
                            @foreach(__getConditionsData() as $key=>$val)
                                <option value="{{$key}}">{{$val}}</option>
                            @endforeach          
                        </select>
                    </div>
                    ...
                    <div class="filter-section">
                        <label for="brands">Brand</label>
                         <select id="brands" class="form-select form-control select2" name="brands[]" multiple>
                            @foreach(__getBrandsData() as $key=>$val)
                                <option value="{{$key}}">{{$val}}</option>
                            @endforeach          
                        </select>
                    </div>
                    ...
                    <div class="filter-section">
                        <label for="horseSizes">Horse Size</label>
                         <select id="horseSizes" class="form-select form-control select2" name="horseSizes[]" multiple>
                            @foreach(__getHorseSizesData() as $key=>$val)
                                <option value="{{$key}}">{{$val}}</option>
                            @endforeach          
                        </select>
                    </div>
                    ...
                    <div class="filter-section">
                        <label for="riderSizes">Rider Size</label>
                         <select id="riderSizes" class="form-select form-control select2" name="riderSizes[]" multiple>
                            @foreach(__getRiderSizesData() as $key=>$val)
                                <option value="{{$key}}">{{$val}}</option>
                            @endforeach          
                        </select>
                    </div>
                    ...
                    <div class="filter-section">
                        <label for="exchangedUpcomingHorseShows">Can be Exchanged at Upcoming Horse Show</label>
                         <select id="exchangedUpcomingHorseShows" class="form-select form-control select2" name="exchangedUpcomingHorseShows[]" multiple>
                            @foreach(__getExchangedUpcomingHorseShows() as $key=>$val)
                                <option value="{{$key}}">{{$val}}</option>
                            @endforeach          
                        </select>
                    </div>
                    ...
                    <div class="filter-section">
                        <h4>Hourly Rental Price</h4>
                        <div class="price-range-min-max">
                            <div>
                                <label for="keyword">Min</label>
                                <input type="text" class="input-filter numbervalid" id="minHourlyPrice" name="minHourlyPrice" />
                            </div>
                            <span>
                                <label for="keyword">&nbsp</label>
                                -
                            ...
                            <div>
                                <label for="keyword">Max</label>
                                <input type="text" class="input-filter numbervalid" id="maxHourlyPrice" name="maxHourlyPrice"/>
                            </div>
                        </div>
                    </div>

                    <div class="filter-section">
                        <h4>Fixed Price Range</h4>
                        <div class="price-range-min-max">
                            <div>
                                <label for="keyword">Min</label>
                                <input type="text" class="input-filter numbervalid" id="minFixedPrice" name="minFixedPrice" />
                            </div>
                            <span>
                                <label for="keyword">&nbsp</label>
                                -
                            ...
                            <div>
                                <label for="keyword">Max</label>
                                <input type="text" class="input-filter numbervalid" id="maxFixedPrice" name="maxFixedPrice" />
                            </div>
                        </div>
...
function loadHorses(page = 1) {
    ...
    $.ajax({
        ...
        data: {
            ...
            horseApparels:$("#horseApparels").val(),
            riderApparels:$("#riderApparels").val(),
            horseTacks:$("#horseTacks").val(),
            trailerTrucks:$("#trailerTrucks").val(),
            forBarns:$("#forBarns").val(),
            equineSupplements:$("#equineSupplements").val(),
            conditions:$("#conditions").val(),
            brands:$("#brands").val(),
            horseSizes:$("#horseSizes").val(),
            riderSizes:$("#riderSizes").val(),
            exchangedUpcomingHorseShows:$("#exchangedUpcomingHorseShows").val(),
            ...
            minFixedPrice:$("#minFixedPrice").val(),
            maxFixedPrice:$("#maxFixedPrice").val(),
