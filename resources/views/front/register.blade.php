...
<head>
    ...
    <title>EliteQuine - Sign Up</title>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-6">
                    <div class="login-section-form">
                        <a href="{{ route('home') }}">
                            <img src="{{ asset('front/auth/assets/img/logos/logo.svg') }}" class="logo"
                                alt="logo">
                        </a>
                        ...
                        <form action="{{ route('registerPost') }}" method="post" class="row g-3 needs-validation error"
                            ...
                            <div class="row form-group">
                                <div class="col-lg-6 Password-form">
                                    ...
                                    <div class="icon_eye">
                                        <img src="{{ asset('front/auth/assets/img/eyeoff.svg') }}"
                                            class="toggle-password-input" data-toggle="#password" alt="Toggle Password">
                                    </div>
                                ...
                                <div class="col-lg-6 Password-form">
                                    ...
                                    <div class="icon_eye">
                                        <img src="{{ asset('front/auth/assets/img/eyeoff.svg') }}"
                                            class="toggle-password-input" data-toggle="#password_confirmation"
                                            alt="Toggle Password">
                                    </div>
                                    <span toggle="#password-field" class="bi bi-eye field-icon toggle-password"></span>
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="form-check pe-0">
                                        <input class="form-check-input" type="radio" name="opt_in_notification"
                                            id="flexRadioDefault1" onclick="toggleBox(this)" value="yes"
                                    ...
                                    <div class="form-check pe-0">
                                        <input class="form-check-input" type="radio" name="opt_in_notification"
                                            id="flexRadioDefault2" onclick="toggleBox(this)" value="no"
...
@endif
                                ...
                                <div class="modal fade" id="notificationModalnext" tabindex="-1"
                                    aria-hidden="true">
            ...
            <div class="modal-content rounded-4 p-3">
                ...
                <div class="modal-body">
                    <div class="table-responsive">
                        <table class="table decline_play align-middle text-center">
                            <thead>
                                <tr>
                ...
                <div class="modal-footer border-0 justify-content-end">
                    <button type="button" class="btn btn-save" data-bs-dismiss="modal"
                        aria-label="Close">Save</button>
                            ...
                            <button class="btn btn-primary w-100" type="submit"
                                id="register-form-submit">Register</button>
                        </form>
                        <h6 class="text-center">Already have an account, <a href="{{ route('login') }}"><ins
                                    class="text-gold">Login
                                    here</ins></a>
                        </h6>
                    </div>
                </div>
                <div class="col-lg-6">
                    <img src="{{ asset('front/auth/assets/img/login-site-img.jpg') }}" class="login-img w-100"
                        alt="img-1">
                </div>
            </div>
        </div>
