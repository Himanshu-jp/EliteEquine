                    ...
                    <div class="map-locations">
                        ...
                        <div class="top-form">
                            ...
                            <button class="search-btn btn btn-warning"
                                onclick="window.location.href='{{ route('barns-listing') }}'">Reset</button>
                        </div>
...
@include("front.autocompletescript")
    ...
    <script>
        ...
        function loadHorses(page = 1) {
            ...
            $('.preloader').show();
            $.ajax({
                url: '{{ url('barns-listing/dataTable') }}',
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    page: page,
                    ...
                    housingStablesAroundHorseShows: $("#housingStablesAroundHorseShows").val(),
                    ftrial_from: $("#ftrial_from").val(),
                    ftrial_to: $("#ftrial_to").val(),

                    minSleep: $("#minSleep").val(),
                    maxSleep: $("#maxSleep").val(),

                    minDailyPrice: $("#minDailyPrice").val(),
                    maxDailyPrice: $("#maxDailyPrice").val(),

                    minMonthlyPrice: $("#minMonthlyPrice").val(),
                    maxMonthlyPrice: $("#maxMonthlyPrice").val(),

                    minWeeklyPrice: $("#minWeeklyPrice").val(),
                    maxWeeklyPrice: $("#maxWeeklyPrice").val(),
