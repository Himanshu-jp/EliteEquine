                            ...
                            <div class="horse-info-box">
                                ...
                                <div class="horse-info-row"><span class="horse-label">Property Types:</span>
                                    {{ @$products->propertyTypes->map(function ($property_types) {
                                            return optional($property_types->commonMaster)->name;
                                        })->filter()->implode(', ') }}
                                </div>
                                <div class="horse-info-row"><span class="horse-label">Stalls Available:</span>
                                    {{ @$products->stableAmenities->map(function ($stable_amenities) {
                                            return optional($stable_amenities->commonMaster)->name;
                                        })->filter()->implode(', ') }}
                                </div>

                                <div class="horse-info-row"><span class="horse-label">Housing or Stables around Horse
                                        Show:</span>
                                    {{ @$products->housingStablesAroundHorseShows->map(function ($housing_stables_around_horse_shows) {
                                            return optional($housing_stables_around_horse_shows->commonMaster)->name;
                                        })->filter()->implode(', ') }}
                                </div>
                                <div class="horse-info-row"><span class="horse-label">Housing Amenities:</span>
                                    {{ @$products->housingAmenities->map(function ($housing_amenities) {
                                            return optional($housing_amenities->commonMaster)->name;
                                        })->filter()->implode(', ') }}
                                </div>

                                <div class="horse-info-row"><span class="horse-label">Daily Board or Rental Rate:</span>
                                    {{ @$products->productDetail->daily_board_rental_rate }}
                                </div>
                                <div class="horse-info-row"><span class="horse-label">Weekly Board or Rental Rate:</span>
                                    {{ @$products->productDetail->weekly_board_rental_rate }}
                                </div>
                                <div class="horse-info-row"><span class="horse-label">Monthly Board or Rental Rate:</span>
                                    {{ @$products->productDetail->monthly_board_rental_rate }}
                                </div>
                                <div class="horse-info-row"><span class="horse-label">Sleeps:</span>
                                    {{ @$products->productDetail->sleeps }}
                                </div>
                                <div class="horse-info-row"><span class="horse-label">Stalls Available:</span>
                                    {{ @$products->productDetail->stalls_available }}
                                </div>
                                <div class="horse-info-row"><span class="horse-label">Trial Dates Available From:</span>
                                    {{ @$products->productDetail->fromdate }}
                                </div>
                                <div class="horse-info-row"><span class="horse-label">Trial Dates To:</span>
                                    {{ @$products->productDetail->todate }}
                                </div>
                                <div class="horse-info-row"><span class="horse-label">Realtor:</span>
                                    {{ @$products->productDetail->realtor }}
                                </div>
                                <div class="horse-info-row"><span class="horse-label">Property Managers:</span>
                                    {{ @$products->productDetail->property_manager }}
                                </div>
