...
@section('content')
                ...
                <div class="col-lg-8">
                    <div class="left-side-deatils">
                            ...
                            <div class="info-desc-footer">
                                <ul>
                                    <li><span> <img src="{{ asset('front/home/assets/images/location-icon.svg') }}"
                                                alt="" /></span> {{ @$community->location }}</li>
                                    {{-- <li><span> <img src="{{asset('front/home/assets/images/show-icon.svg')}}" alt="" /></span> 30 #11223</li> --}}
                                    <li>
                                        <span> Created Date : <img
                                                src="{{ asset('front/home/assets/images/calendar-icon.svg') }}"
                                                alt="" /></span>
                        ...
                        <div class="info-desc">
                            ...
                            <div class="horse-info-row"><span class="horse-label">Title :</span> {{ @$community->title }}
                            </div>
                            <div class="horse-info-row"><span class="horse-label">Requirement:</span>
                                {{ @$community->requirement }} </div>
                            <div class="horse-info-row"><span class="horse-label">Date & Time:</span>
                                {{ \Carbon\Carbon::parse($community->date)->format('d M Y') }} :
                                {{ \Carbon\Carbon::parse($community->time)->format('h:i A') }}
                            </div>
                    ...
                    <div class="details-right">
                        ...
                        <div class="card-boxleft">
                            ...
                            <div>
                                @if (isset($attending))
                                    <div class="btn-connected gap-2">
                                        ...
                                        @if ($community->user_id == auth()->id())
                                            <a href="{{ route('community.edit', $community->id) }}"><button
                                ...
                                @else
                                    <div class="btn-connected gap-2">
                                        @if ($community->user_id == auth()->id())
                                            ...
                                            <a href="{{ route('community.edit', $community->id) }}"><button
                                                    class="call-price w-100 chat-btn">Edit</button></a>
                                        @else
                                            <button type="button"
                                                onclick="window.location.href='{{ route('community.join', $community->id) }}'"
                                                class="call-price w-100">Join Now</button>
                                            <button class="call-price chat-btn"
                                                onclick="{{ auth()->check() ? 'chatCreate();' : 'showLoginModal("Please login to chat with ad owner.")' }}">
                                                <img src="{{ asset('front/home/assets/images/chat-icon.svg') }}"
                                                    alt="" />
                                ...
                                @endif
                                <p class="text-center py-3">Event Date :
                                    {{ \Carbon\Carbon::parse($community->date)->format('d M Y') }} :
                                    {{ \Carbon\Carbon::parse($community->time)->format('h:i A') }} </p>
                            ...
                            <div class="ad-owner-btn">
                                ...
                                <div class="owner-profile">
                                    <div class="profil-info">
                                        <div class="proimg">
                                            <img src="{{ @$community->user->profile_photo_path ? asset('storage/' . @$community->user->profile_photo_path) : asset('front/auth/assets/img/user-img.png') }}"
                                                class="user-img" alt="">
                                        ...
                                        <div class="proname">
                                            ...
                                            <div data-bs-target="#Rating" data-bs-toggle="modal"><img
                                                    src="{{ asset('front/home/assets/images/star-rating5.svg') }}"
                                                    alt="" /></div>
                                        </div>
                                    </div>
                                    {{-- <div class="btn-right">
                                ...
                                <div class="connect-numr" id="contact-reval"
                                    data-last-digit="{{ substr(@$community->user->getUserDetail->phone, -3) }}">
                                    ...
                                    <div class="modal-content text-center">
                                        <div class="modal-body p-4">
                                            ...
                                            <div class="rating-card">
                                                <div class="user-info">
                                                    <img src="{{ asset('front/home/assets/images/users/Ellipse 1-1.png') }}"
                                                        height="49" alt="Ellipse">
                                                    <h5>Jonas Sousa</h5>
                                                </div>
                                                <img src="{{ asset('front/home/assets/images/icons/stars02.png') }}"
                                                    height="18" alt="stars02">
                                            </div>
                                            <div class="rating-card">
                                                <div class="user-info">
                                                    <img src="{{ asset('front/home/assets/images/users/Ellipse 1-2.png') }}"
                                                        height="49" alt="Ellipse">
                                                    <h5>Jonas Sousa</h5>
                                                </div>
                                                <img src="{{ asset('front/home/assets/images/icons/stars01.png') }}"
                                                    height="18" alt="stars02">
                                            </div>
                                            <div class="rating-card">
                                                <div class="user-info">
                                                    <img src="{{ asset('front/home/assets/images/users/Ellipse 1-3.png') }}"
                                                        height="49" alt="Ellipse">
                                                    <h5>Jonas Sousa</h5>
                                                </div>
                                                <img src="{{ asset('front/home/assets/images/icons/stars02.png') }}"
                                            ...
                                            <div class="rating-card">
                                                <div class="user-info">
                                                    <img src="{{ asset('front/home/assets/images/users/Ellipse 1.png') }}"
                                                        height="49" alt="Ellipse">
                                                    <h5>Jonas Sousa</h5>
                                                </div>
                                                <img src="{{ asset('front/home/assets/images/icons/stars02.png') }}"
    ...
    <script>
        ...
        function initializeMap(latitude, longitude, trailLat, trailLong) {
            ...
            var markerIconUrlTrail = "{{ env('MAP_PUBLIC') }}/images/Community Red.png";
