            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('blogs.store') }}" id="blog_create" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <!-- Title -->
...
$(document).ready(function () {
    ...
    .then(editor => {
        blogEditor = editor;  // Correctly assign editor instance
    })
    .catch(error => {
        console.error('CKEditor initialization failed:', error);
    });

    $('#blog_create').validate({
        rules: {
    ...
    // On reset button click, clear validation errors and reset CKEditor content
    $('#resetBtn').click(function () {
        ...
        if (blogEditor) {
            blogEditor.setData(''); // Clear CKEditor content
        }
    });
});
</script>
