...
@section('title', 'View Seller Business')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Seller Business - View</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">View Seller Business</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="d-flex justify-content-end mt-4 mr-4">
                            @if(!$business)
                            <a href="{{ route('seller-business.create') }}" class="btn btn-primarys">Add Seller Business</a>
                            @else
                            <a href="{{ route('seller-business.edit', $business->id) }}" class="btn btn-primarys">Edit Seller Business</a>
                            @endif
                        </div>
                <div class="card-body">
                    <!-- Title -->
