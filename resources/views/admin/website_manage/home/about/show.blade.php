...
@section('title', 'Home About Details')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Home About Details</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="d-flex justify-content-end mt-4 mr-4">
                            @if(!$about)
                            <a href="{{ route('home_about.create') }}" class="btn btn-primarys">Add About</a>
                            @else
                            <a href="{{ route('home_about.edit', $about->id) }}" class="btn btn-primarys">Edit About</a>
                            @endif
                        </div>
                        <div class="card-body">
