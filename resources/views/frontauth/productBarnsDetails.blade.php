...
@section('content')
    ...
    <div class="container-fluid mt-4">
        ...
        <form action="{{ route('productBarnsDetails') }}" method="post" class="row" id="productDetailsForm"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mt-3 position-relative">
                        ...
                        <select class="form-control select2" id="sub_category" name="sub_category[]" multiple="multiple">
                            @foreach ($subcategories as $key => $value)
                                <option value="{{ $key }}"
                                    {{ in_array($key, old('sub_category', @$products->subcategory->pluck('category_id')->toArray())) ? 'selected' : '' }}>
                                    {{ $value }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-3 mt-3 position-relative">
                        ...
                        <select class="form-control select2" id="property_types" name="property_types[]"
                            multiple="multiple">
                            @foreach (__getPropertytypesData() as $key => $value)
                                <option value="{{ $key }}"
                                    {{ in_array($key, old('property_types', @$products->propertyTypes->pluck('common_master_id')->toArray())) ? 'selected' : '' }}>
                                    {{ $value }}</option>
                            @endforeach
                        </select>
                        <i class="fi fi-rr-angle-small-down"
                    ...
                    <div class="col-md-3 mt-3 position-relative">
                        ...
                        <input type="text" name="stalls_available" id="stalls_available"
                            class="inner-form form-control mb-0 numbervalid" placeholder="Enter available stalls count"
                            value="{{ old('stalls_available', @$products->productDetail->stalls_available) }}">
                    ...
                    <div class="col-md-3 mt-3 position-relative">
                        ...
                        <select class="form-control select2" id="stable_amenities" name="stable_amenities[]"
                            multiple="multiple">
                            @foreach (__getStableAmenitiesData() as $key => $value)
                                <option value="{{ $key }}"
                                    {{ in_array($key, old('stable_amenities', @$products->stableAmenities->pluck('common_master_id')->toArray())) ? 'selected' : '' }}>
                                    {{ $value }}</option>
                            @endforeach
                        </select>
                        <i class="fi fi-rr-angle-small-down"
                    ...
                    <div class="col-md-3 mt-3 position-relative">
                        <label for="exampleFormControlInput1" class="form-label">Housing or Stables around Horse
                            Show</label>
                        <select class="form-control select2" id="housing_stables_around_horse_shows"
                            name="housing_stables_around_horse_shows[]" multiple="multiple">
                            @foreach (__getHousingStable() as $key => $value)
                                <option value="{{ $key }}"
                                    {{ in_array($key, old('housing_stables_around_horse_shows', @$products->housingStablesAroundHorseShows->pluck('common_master_id')->toArray())) ? 'selected' : '' }}>
                                    {{ $value }}</option>
                            @endforeach
                        </select>
                        <i class="fi fi-rr-angle-small-down"
                        ...
                        @if ($errors->has('housing_stables_around_horse_shows'))
                            <span
                                class="error text-danger">{{ $errors->first('housing_stables_around_horse_shows') }}</span>
                        @endif
                    </div>
                    ...
                    <div class="col-md-3 mt-3 position-relative">
                        ...
                        <input type="text" name="sleeps" id="sleeps"
                            class="inner-form form-control mb-0 numbervalid" placeholder="Enter sleeps"
                            value="{{ old('sleeps', @$products->productDetail->sleeps) }}">
                    ...
                    <div class="col-md-3 mt-3 position-relative">
                        ...
                        <select class="form-control select2" id="housing_amenities" name="housing_amenities[]"
                            multiple="multiple">
                            @foreach (__getHousingAmenitiesData() as $key => $value)
                                <option value="{{ $key }}"
                                    {{ in_array($key, old('housing_amenities', @$products->housingAmenities->pluck('common_master_id')->toArray())) ? 'selected' : '' }}>
                                    {{ $value }}</option>
                            @endforeach
                        </select>
                        <i class="fi fi-rr-angle-small-down"
                    ...
                    <div class="col-md-3 mt-3 position-relative">
                        ...
                        <input type="text" name="daily_board_rental_rate" id="daily_board_rental_rate"
                            class="inner-form form-control mb-0 numbervalid" placeholder="Enter daily board rental rate"
                            value="{{ old('daily_board_rental_rate', @$products->productDetail->daily_board_rental_rate) }}">
                    ...
                    <div class="col-md-3 mt-3 position-relative">
                        ...
                        <input type="text" name="weekly_board_rental_rate" id="weekly_board_rental_rate"
                            class="inner-form form-control mb-0 numbervalid" placeholder="Enter weekly board rental rate"
                            value="{{ old('weekly_board_rental_rate', @$products->productDetail->weekly_board_rental_rate) }}">
                    ...
                    <div class="col-md-3 mt-3 position-relative">
                        ...
                        <input type="text" name="monthly_board_rental_rate" id="monthly_board_rental_rate"
                            class="inner-form form-control mb-0 numbervalid" placeholder="Enter monthly borad rental rate"
                            value="{{ old('monthly_board_rental_rate', @$products->productDetail->monthly_board_rental_rate) }}">
                    ...
                    <div class="col-md-3 mt-3 position-relative">
                        ...
                        <input type="text" name="sale_cost" id="sale_cost"
                            class="inner-form form-control mb-0 numbervalid" placeholder="Enter sale cost"
                            value="{{ old('sale_cost', @$products->productDetail->sale_cost) }}">
                    ...
                    <div class="col-md-3 mt-3 position-relative">
                        ...
                        <input type="text" name="realtor" id="realtor" class="inner-form form-control mb-0"
                            placeholder="Enter realtor name"
                            value="{{ old('realtor', @$products->productDetail->realtor) }}">
                    ...
                    <div class="col-md-3 mt-3 position-relative">
                        ...
                        <input type="text" name="property_manager" id="property_manager"
                            class="inner-form form-control mb-0" placeholder="Enter property managers name here"
                            value="{{ old('property_manager', @$products->productDetail->property_manager) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-4 position-relative">
                            ...
                            <input type="text" class="inner-form form-control" placeholder="Enter location.."
                                name="precise_location" id="precise_location" onkeyup="initializeLocationAutocomplete()"
            ...
            <div class="form-check pt-2 position-relative mt-3">
       ...
       let mapboxAccessToken = '{{ config('config.map_box_access_token') }}';
        ...
        function addMapMarker(lat, lng, target = 'main', fly = false) {
            ...
            const markerImage = target === 'main' ?
                `${MAP_PUBLIC}/images/Barn and housing Red.png` :
                `${MAP_PUBLIC}/images/Barn and housing Blue.png`;
        ...
        $(document).ready(function() {
            ...
            $('#productDetailsForm').validate({
                ...
                messages: {
                    ...
                    'stable_amenities[]': {
                        required: "Please select at least one stable amenity."
                    },
                    'housing_stables_around_horse_shows[]': {
                    ...
                    'housing_amenities[]': {
                        required: "Please select at least one housing amenity."
                    },
