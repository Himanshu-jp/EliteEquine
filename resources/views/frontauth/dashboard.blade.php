                        ...
                        <div class="radial-chart-wrapper">
                            <svg class="radial-chart" viewBox="0 0 200 200">
                                ...
                                <circle cx="100" cy="100" r="85" fill="none" stroke="#4A90E2" stroke-width="8"
                                    stroke-dasharray="267 267" stroke-dashoffset="80" stroke-linecap="round"
                                    class="chart-segment outer-ring" />

                                <!-- Middle ring - Equipment & Apparel (Orange) -->
                                <circle cx="100" cy="100" r="65" fill="none" stroke="#FF9800" stroke-width="8"
                                    stroke-dasharray="204 204" stroke-dashoffset="61" stroke-linecap="round"
                                    class="chart-segment middle-ring" />

                                <!-- Inner ring - Horses (Green) -->
                                <circle cx="100" cy="100" r="45" fill="none" stroke="#4CAF50" stroke-width="8"
                                    stroke-dasharray="141 141" stroke-dashoffset="28" stroke-linecap="round"
                                    class="chart-segment inner-ring" />
                            </svg>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if(@$value->product_status == 'live')
                                                    <span class="badge"
                                                        style="background-color:#00A591;">{{(@$value->product_status) ? @$value->product_status : 'N/A'}}</span>
                                                @elseif(@$value->product_status == 'expire')
                                                    <span class="badge"
                                                        style="background-color:red;">{{@$value->product_status}}</span>
                                            ...
                                            {{-- <td class="align-middle text-center">
                                                <span class="text-xs font-weight-bold">{{
                                                    (@$value->productDetail->age)?\Carbon\Carbon::parse("01-01-".@$value->productDetail->age)->age:0}}
                                                    Years</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span
