...
// const socket = io("https://v5.checkprojectstatus.com:3115");
            ...
            if(data.type=="SINGLE")
            {
              if(data.chatuser[0].get_user && data.chatuser[1].get_user)
              {
                ...
                if(data.chatuser[0].get_user && parseInt(data.chatuser[0].user_id) != parseInt(SENDER_ID))
                {
                  ...
                  profile = data.chatuser[0].get_user.profile_image ? data.chatuser[0].get_user.profile_image: 'https://circlequay.com/public/frontend/bussiness/images/user_male_icon.png';  
                ...
                if(data.chatuser[1].get_user &&  parseInt(data.chatuser[1].user_id) != parseInt(SENDER_ID))
                {
                  ...
                  profile = data.chatuser[1].get_user.profile_image ? data.chatuser[1].get_user.profile_image: 'https://circlequay.com/public/frontend/bussiness/images/user_male_icon.png';  
    	...
    	if(data.chatuser[0].get_user && parseInt(data.chatuser[0].user_id) != parseInt(SENDER_ID))
            {
            	var RECEIVER_ID = data.chatuser[0].get_user.id ? data.chatuser[0].get_user.id:  data.chatuser[0].get_user.id;  
                  user_name = data.chatuser[0].get_user.name ? data.chatuser[0].get_user.name:  data.chatuser[0].get_user.email;  
                  user_profile = data.chatuser[0].get_user.profile_image ? data.chatuser[0].get_user.profile_image: 'https://circlequay.com/public/frontend/bussiness/images/user_male_icon.png';  
                  user_role  = data.chatuser[0].get_user.user_role;
                  if(parseInt(data.chatuser[0].get_user.is_online) == 1)
                  {
                    is_online = 'online'
        ...
        if(data.chatuser[1].get_user &&  parseInt(data.chatuser[1].user_id) != parseInt(SENDER_ID))
            {
                  ...
                  user_name = data.chatuser[1].get_user.name ? data.chatuser[1].get_user.name : data.chatuser[0].get_user.email;
                  user_profile = data.chatuser[1].get_user.profile_image ? data.chatuser[1].get_user.profile_image: 'https://circlequay.com/public/frontend/bussiness/images/user_male_icon.png';  
