            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="text" class="inner-form form-control" placeholder="Enter location.." name="precise_location" onkeyup="initializeLocationAutocomplete()" id="precise_location" value={{old('precise_location',@$userDetails->precise_location)}}>
