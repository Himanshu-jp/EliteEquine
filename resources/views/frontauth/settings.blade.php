                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" class="inner-form form-control" placeholder="Enter location.."
                                name="precise_location" id="precise_location"
                        ...
                        <thead style="border-bottom: 1px solid #dee2e6;">
                            <tr>
                                <th style="border: 1px solid #dee2e6;"
                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Alert Type
                                </th>
                                <th style="border: 1px solid #dee2e6;"
                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Email
                                </th>
                                <th style="border: 1px solid #dee2e6;"
    ...
    <script>
        $(document).ready(function() {
            ...
            mapboxgl.accessToken =
                'pk.eyJ1IjoiZWxpdGVlcXVpbmVtYXJrZXRwbGFjZSIsImEiOiJjbWJyemJpbnUwZmo3MmtzZjhkcjEydjFpIn0.W8xnRIfKQOCpSdAlhAPSlA';
