            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="text" class="inner-form form-control" onkeyup="initializeLocationAutocomplete()" placeholder="Enter location.." name="precise_location" id="precise_location" value={{old('precise_location',@$userDetails->precise_location)}}>
