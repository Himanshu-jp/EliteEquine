...
class SellerBusinessRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'image' => 'nullable|file|mimes:jpg,jpeg,png,svg,webp|max:5120', // max 5MB

            'description' => 'required|string|min:10|max:3000',

            // Listing Section
            'listing_icon' => 'nullable|file|mimes:jpg,jpeg,png,svg,webp|max:2048',
            'listing_title' => 'required|string|max:255',
            'listing_content' => 'required|string|min:5|max:3000',

            // Track Section
            'track_icon' => 'nullable|file|mimes:jpg,jpeg,png,svg,webp|max:2048',
            'track_title' => 'required|string|max:255',
            'track_content' => 'required|string|min:5|max:3000',

            // Featured Section
            'featured_icon' => 'nullable|file|mimes:jpg,jpeg,png,svg,webp|max:2048',
            'featured_title' => 'required|string|max:255',
            'featured_content' => 'required|string|min:5|max:3000',

            // Post Section
            'post_icon' => 'nullable|file|mimes:jpg,jpeg,png,svg,webp|max:2048',
